...
su -s /bin/sh - ${GIT_USER} -c "git init --bare /home/${GIT_USER}/vaults/${VAULT}.git"  # UNTESTED (MAYBE #22? OR 24?)

# 6. Safe.directory for vault
su -s /bin/sh - ${REG_USER} -c "git config --global --add safe.directory /home/${GIT_USER}/vaults/${VAULT}.git"  # TESTED (#26)
...
su -s /bin/sh - ${REG_USER} -c "git clone /home/${GIT_USER}/vaults/${VAULT}.git /home/${REG_USER}/vaults/${VAULT}"  # TESTED (#33)

# 9. Safe.directory for working clone & initial commit
su -s /bin/sh - ${REG_USER} -c "git config --global --add safe.directory /home/${REG_USER}/vaults/${VAULT}"  # TESTED (#35)
